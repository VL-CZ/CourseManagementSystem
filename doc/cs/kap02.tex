...
Frontend část aplikace má také na starost routing. Samotný router je součástí frameworku, nicméně potřebujeme nějak nakonfigurovat, jaká komponenta se zobrazí při dotazu na danou URL.
...
Konfigurace nám říká, že na výchozí stránce se zobrazí komponenta HomeComponent. Druhý řádek nám říká, že při zadání URL "http://host/students/id", kde id je parametr, se zobrazí komponenta StudentDetailComponent. K parametru id se poté můžeme dostat v komponentě.
