...
Komponenty představují UI aplikace a slouží k zobrazování dat. Každá komponenta má 2 části: šablonu a backend. Šablona je typicky napsaná v HTML, zatímco backend komponenty je v jazyce Typescript. 
